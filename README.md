...
<div><img alt="Logo" src="https://raw.githubusercontent.com/wessberg/@berufungirnpm/sed-cumque-unde/master/documentation/asset/@berufungirnpm/sed-cumque-unde-logo.png" height="150"   /></div>
...
<a href="https://npmcharts.com/compare/@berufungirnpm/sed-cumque-unde?minimal=true"><img alt="Downloads per month" src="https://img.shields.io/npm/dm/@berufungirnpm/sed-cumque-unde.svg"    /></a>
<a href="https://www.npmjs.com/package/@berufungirnpm/sed-cumque-unde"><img alt="NPM version" src="https://badge.fury.io/js/@berufungirnpm/sed-cumque-unde.svg"    /></a>
<img alt="Dependencies" src="https://img.shields.io/librariesio/github/wessberg%2F@berufungirnpm/sed-cumque-unde.svg"    />
<a href="https://github.com/berufungirnpm/sed-cumque-unde/graphs/contributors"><img alt="Contributors" src="https://img.shields.io/github/contributors/wessberg%2F@berufungirnpm/sed-cumque-unde.svg"    /></a>
...
[Become a sponsor/backer](https://github.com/berufungirnpm/sed-cumque-unde?sponsor=1) and get your logo listed here.
...
```
$ npm install @berufungirnpm/sed-cumque-unde --save-dev
```

### Yarn

```
$ yarn add @berufungirnpm/sed-cumque-unde --dev
```

### pnpm

```
$ pnpm add @berufungirnpm/sed-cumque-unde --save-dev
```

### Peer Dependencies

`@berufungirnpm/sed-cumque-unde` depends on `rollup` and `typescript`, so you need to manually install these as development dependencies as well.
...
```javascript
import ts from "@berufungirnpm/sed-cumque-unde";
export default {
	// ...
	plugins: [
		ts({
...
Don't worry if you don't, `@berufungirnpm/sed-cumque-unde` will warn you about exactly which dependencies are missing once you run it.
...
<img alt="TSC emitted code" src="https://raw.githubusercontent.com/wessberg/@berufungirnpm/sed-cumque-unde/master/documentation/asset/tsc-output-example.png" height="250"   />

Rollup is a bundler, and with it, we can produce clean, small files that are easy to distribute.
With `@berufungirnpm/sed-cumque-unde`, declaration files will be bundled, tree-shaken and emitted alongside the chunks emitted by Rollup:

<img alt="Plugin emitted code" src="https://raw.githubusercontent.com/wessberg/@berufungirnpm/sed-cumque-unde/master/documentation/asset/plugin-output-example.png" height="250"   />

And, it even works in complex code splitting scenarios:

<img alt="Plugin emitted code with code splitting" src="https://raw.githubusercontent.com/wessberg/@berufungirnpm/sed-cumque-unde/master/documentation/asset/plugin-output-example-code-splitting.png" height="250"   />
...
You can use pass a specific TypeScript to use as an option. This may be useful if you are using different TypeScript versions across packages inside a monorepo and you want to use a specific one with `@berufungirnpm/sed-cumque-unde`:
...
`@berufungirnpm/sed-cumque-unde` provides a few hooks that allow you to hook into and augment the internal behavior of the plugin.
...
The `outputPath` hook can be used to rewrite the location on the filesystem that assets produced by `@berufungirnpm/sed-cumque-unde` are written to.
...
Use this property to get hooks into the internals of `@berufungirnpm/sed-cumque-unde`.
...
The following is an evolving list of starter templates for new projects using Rollup, TypeScript, and `@berufungirnpm/sed-cumque-unde` that you can take a look at and draw inspiration from.

- [Library with CommonJS and ESM output and TypeScript declarations](https://repl.it/@wessberg/@berufungirnpm/sed-cumque-unde-library-cjs-esm-declarations-1)
